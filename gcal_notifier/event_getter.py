...
def make_conn(calendar: str = 'primary',
              credentials: str = CONFIG+'/credentials.json'
              ) -> GoogleCalendar:
...
def load_calendars(general_params: Dict[str, Any],
                   calendar_params: Dict[str, dict]
    ...
    for _, params in calendar_params.items():
        ...
        calendars[params['name']] = make_conn(**conn_params).get_events(**general_params)
    return calendars
